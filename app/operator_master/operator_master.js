...
$scope.operatorregistration = {id: null,name:"",spec_id:"",description:""};
//$scope.username=localStorage.getItem("username");
$scope.operatorForm= function(){  
 
        var operatorregistration = {"name":$scope.operatorregistration.name,"spec_id":$scope.operatorregistration.spec_id,"description":$scope.operatorregistration.description};
...
$scope.cleardata=  {id: null,name:"",spec_id:"",description:""};
